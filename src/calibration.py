...
class StereoCalibration:
    ...
    def _init_paths(self) -> None:
        ...
        self._left_image_names = [
            name for name in self._left_image_names if name.endswith(".jpg")
        ]
        self._right_image_names = [
            name for name in self._right_image_names if name.endswith(".jpg")
        ]
    ...
    def calibrate(self) -> Tuple[np.ndarray, np.ndarray]:
        ...
        print("Instrisic LEFT camera matrix: ")
        ...
        print("Instrisic RIGHT camera matrix: ")
